...
class TransferList extends _$TransferList {
  ...
  late final int _investmentId;

  @override
  PagingStatus build(int investmentId) {
  ...
  Future<void> fetchPage(int page, {int limit = 10}) async {
    final Either<String, c.TransferList> result = await ref
        .read(transferServiceProvider)
        .list(_investmentId, page: page, limit: limit);
