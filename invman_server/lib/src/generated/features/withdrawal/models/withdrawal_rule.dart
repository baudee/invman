...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i2;
import '../../../features/withdrawal/models/withdrawal_fee.dart' as _i3;
...
class WithdrawalRuleRepository {
  ...
  /// Acquires row-level locks on [WithdrawalRule] rows matching the [where] expression.
  Future<void> lockRows(
    ...
    return session.db.lockRows<WithdrawalRule>(
      where: where(WithdrawalRule.t),
      lockMode: lockMode,
      lockBehavior: lockBehavior,
      transaction: transaction,
