...
import '../../../features/withdrawal/models/withdrawal_rule.dart' as _i2;
...
class WithdrawalFeeRepository {
  ...
  /// Acquires row-level locks on [WithdrawalFee] rows matching the [where] expression.
  Future<void> lockRows(
    ...
    return session.db.lockRows<WithdrawalFee>(
      where: where(WithdrawalFee.t),
      lockMode: lockMode,
      lockBehavior: lockBehavior,
      transaction: transaction,
