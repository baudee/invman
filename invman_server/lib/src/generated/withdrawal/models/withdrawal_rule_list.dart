...
abstract class WithdrawalRuleList
  ...
  factory WithdrawalRuleList.fromJson(Map<String, dynamic> jsonSerialization) {
    return WithdrawalRuleList(
      ...
      results: _i3.Protocol().deserialize<List<_i2.WithdrawalRule>>(
  ...
  /// Returns a shallow copy of this [WithdrawalRuleList]
  ...
  Map<String, dynamic> toJson() {
    return {
      '__className__': 'WithdrawalRuleList',
      'count': count,
