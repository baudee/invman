...
abstract class InvestmentList
  ...
  factory InvestmentList.fromJson(Map<String, dynamic> jsonSerialization) {
    return InvestmentList(
      ...
      results: _i3.Protocol().deserialize<List<_i2.Investment>>(
  ...
  /// Returns a shallow copy of this [InvestmentList]
