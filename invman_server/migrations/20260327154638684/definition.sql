...
-- Indexes
CREATE UNIQUE INDEX "asset_symbol_exchange_idx" ON "asset" USING btree ("symbol", "exchange");
CREATE INDEX "asset_name_idx" ON "asset" USING btree ("name");
...
-- Indexes
CREATE UNIQUE INDEX "asset_like_user_asset_idx" ON "asset_like" USING btree ("userId", "assetId");
...
--
-- Foreign relations for "asset_like" table
--
ALTER TABLE ONLY "asset_like"
    ADD CONSTRAINT "asset_like_fk_0"
    FOREIGN KEY("userId")
    REFERENCES "serverpod_auth_core_user"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "asset_like"
    ADD CONSTRAINT "asset_like_fk_1"
    FOREIGN KEY("assetId")
    REFERENCES "asset"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('invman', '20260327154638684', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260327154638684', "timestamp" = now();
