...
--
-- Class CurrencyRate as table currency_rate
--
...
-- Indexes
CREATE INDEX "currency_rate_idx" ON "currency_rate" USING btree ("currencyId", "timestamp");
...
CREATE TABLE "investment" (
    ...
    "investAmount" double precision NOT NULL DEFAULT 0.0,
...
--
-- Class StockPrice as table stock_price
--
...
-- Indexes
CREATE INDEX "stock_price_idx" ON "stock_price" USING btree ("stockId", "timestamp");
...
--
-- Foreign relations for "currency_rate" table
--
ALTER TABLE ONLY "currency_rate"
    ADD CONSTRAINT "currency_rate_fk_0"
    FOREIGN KEY("currencyId")
    REFERENCES "currency"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
ALTER TABLE ONLY "investment"
    ...
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "investment"
    ADD CONSTRAINT "investment_fk_2"
...
--
-- Foreign relations for "stock" table
--
...
--
-- Foreign relations for "stock_price" table
--
ALTER TABLE ONLY "stock_price"
    ADD CONSTRAINT "stock_price_fk_0"
    FOREIGN KEY("stockId")
    REFERENCES "stock"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('invman', '20260209175855549', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260209175855549', "timestamp" = now();
