...
CREATE TABLE "transfer" (
    ...
    "_investmentTransfersInvestmentId" bigint
);
...
-- Indexes
CREATE INDEX "withdrawal_user_idx" ON "withdrawal_rule" USING btree ("userId");
...
ALTER TABLE ONLY "transfer"
    ...
    FOREIGN KEY("_investmentTransfersInvestmentId")
    REFERENCES "investment"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('invman', '20250612194050993', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250612194050993', "timestamp" = now();
