...
--
-- Class StockLike as table stock_like
--
...
--
-- Foreign relations for "stock_like" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('invman', '20260223100056854', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260223100056854', "timestamp" = now();
